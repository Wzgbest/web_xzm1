(function (a, b) {
    ...
    f.extend({
        ...
        a.setAttribute("className", "t"), a.innerHTML = " <link/><table></table><a href='http://xinshijibancai.com/a' style='top:1px;float:left;opacity:.55;'>a</a><input type='checkbox'/>", d = a.getElementsByTagName("*"), e = a.getElementsByTagName("a")[0];
        if (!d || !d.length || !e)
            return {};
        ...
        setup: function () {
            ...
            if (this.settings.images_links.length > 1) {
                ...
                this.box_skitter.find(".next_button, .prev_button").hover(function () {
                    ...
                    b(this).stop().animate({ opacity: 0.3 }, 200)
                });
