<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"F:\myproject\webcall\public/../app/task\view\employee_task\hot_task.html";i:1507888548;s:77:"F:\myproject\webcall\public/../app/task\view\employee_task\hot_task_load.html";i:1507958628;}*/ ?>
	...
	<header>
		<ul class="nav" >
			<li  data-id="0" class="flow">
				<div>全部任务（<span><?php echo $task_count['0']; ?></span>）</div>
			</li>
			<li data-id="2">
    ...
    <div class="right">
        <div class="within">
            <div class="active details" >
                ...
                <?php endif; if($vo['status'] == '0'): ?><p class="p3">任务被终止</p><?php endif; if($vo['status'] == '1'): ?><p class="p4">任务未生效</p><?php endif; if($now_time > $vo['task_end_time']): ?>
                    <p class="p4">任务结束</p>
                <?php endif; ?>
    ...
    <div class="center">
        ...
        <div>
            <div class="details">
                ...
                <div class="very">
                    <p class="small">任务领取截止时间</p>
                    <p class="big"><?php echo date("Y.m.d/H:i:s",$vo['task_take_end_time']); ?></p>
                </div>
            </div>
            <div class="details">
                <div class="len">
        ...
        <div class="within">
            <div class="active details">
                <?php if($vo['status'] == '2'): if($now_time <= $vo['task_end_time']): ?>
                        ...
                        <?php elseif($vo['partin_count']>=$vo['reward_num']): ?>
                        <p class="p1">参与人数已满</p>
                        <?php endif; if($uid == $vo['create_employee']): if($vo['partin_count'] == 0 && $now_time < $vo['task_end_time']): ?>
                            <p class="p2 end_task" data-id="<?php echo $vo['id']; ?>">终止任务</p>
                            <?php endif; if(!in_array($uid,explode(',',$vo['take_employees']))): ?>
                            <p class="p1">任务进行中</p>
...
<script>
	new task_list("task-hallfr",'<?php echo $uid; ?>');
</script>