...
class RedBonus
{
    ...
    public function __construct($totalMoney, $num, $rangeStart, $rangeEnd, $randFormatType = 'No_Left')
    {
        $this->num = $num;
        $this->rangeStart = $rangeStart;
        $this->rangeEnd = $rangeEnd;
        $this->totalMoney = $totalMoney;
        $this->minMoney = $rangeStart;
        $this->maxMoney = $rangeEnd;
        $this->leftMoney = $totalMoney;
        $this->formatType = $randFormatType;
    }
