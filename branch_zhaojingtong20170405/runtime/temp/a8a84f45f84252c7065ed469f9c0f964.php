<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"F:\myproject\webcall\public/../app/task\view\task_comment\show.html";i:1506389343;}*/ ?>
<?php if(is_array($commont_list) || $commont_list instanceof \think\Collection || $commont_list instanceof \think\Paginator): $i = 0; $__LIST__ = $commont_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
    <div class="one">
