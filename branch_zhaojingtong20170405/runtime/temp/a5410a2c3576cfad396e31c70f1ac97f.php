			...
			<div class="dv4">
				...
				<div class="parcel">
					<div class="left hezi">
						...
						<!--<select>
                            <option>李文璐、王大宝、张三等</option>
                            <option>张萌萌等</option>
                            <option>刘大宝等</option>
                        </select>-->
						<!--<div id="cityMR2" style="width:233px;padding-right:10px;overflow: hidden;" ></div>-->
						<div id="cityMR2" class="public_to_take" style="width:225px;padding-right:10px;overflow: hidden;padding-left: 20px;" >
						</div>
					</div>
					<div class="right hezi">
						<img src="/task/img/star.png" />
				...
				<!--<div class="tab" style="display: block;">
                    ...
                    <ul>
                        ...
                        <li>奖励前<span>15</span>名，将支付<span>1000</span>元作为激励奖金</li>
                    </ul>
                    ...
                    <div class="parcel">
                        <div class="normal">
                            <img src="/task/img/star.png" />
                            <span>统计周期</span>
                            <input type="datetime-local" style="line-height: 35px;" />
                            <span class="set">到</span>
                            <input type="datetime-local" style="line-height: 35px;" />
                        </div>
                    </div>
                    <div class="last">
                        <span>任务说明</span>
                        <textarea placeholder="请输入任务说明内容"></textarea>
                    </div>
                </div>-->
				<div class="tab">
					<div class="parcel">
				...
				<div class="tab1" style="display: block;">
					...
					<div class="parcel">
						<div class="len">
							...
							<span>分配规则</span>
							<span class="set">第</span>
							<input type="text" placeholder="1" class="num1"/>
							<span class="set">到</span>
							<input type="text" placeholder="5" class="num2"/>
							<span>名</span>
							<span class="set">奖金</span>
							<input type="text" placeholder="100" class="num3"/>
							<span class="set">元</span>
							<img src="/task/img/add.png" class="add" />
						</div>
					</div>
				...
				<!--<div class="tab">
                    ...
                    <ul>
                        ...
                        <li>第<span>4</span>~<span>6</span>名，各奖励<span>100</span>元<i class="fa fa-edit"></i><i class="fa fa-trash-o"></i></li>
                        <li>第<span>7</span>~<span>15</span>名，各奖励<span>50</span>元<i class="fa fa-edit"></i><i class="fa fa-trash-o"></i></li>
                        <li>奖励前<span>0</span>名，将支付<span class="total">0</span>元作为激励奖金</li>
                    </ul>
