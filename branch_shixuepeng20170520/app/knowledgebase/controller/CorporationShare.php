...
class CorporationShare extends Initialize{
    ...
    public function addComment(){
        ...
        save_msg($str,"/knowledgebase/corporation_share/index",$receive_uids,5,13,$uid,0,$sms);
        if ($comment_id) {
            save_msg($userinfos['truename']."回复了你的评论","/knowledgebase/corporation_share/index",[$reviewer_id],5,13,$uid,$share_id,$sms);
        }
