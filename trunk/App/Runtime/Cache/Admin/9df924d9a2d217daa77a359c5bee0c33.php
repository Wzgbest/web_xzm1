    ...
    <div class="page-content">
        ...
        <div class="container-fluid">
            ...
            <div id="dashboard">
                ...
                <!--<div class="row-fluid">-->
                        ...
                        <!--<div class="portlet solid bordered light-grey">-->
                            ...
                            <!--<div class="portlet-body">-->
                                <!--<div id="site_statistics_loading">-->
                                    <!--<img src="/Public/Admin/image/loading.gif" alt="loading"/>-->
                                <!--</div>-->
                    ...
                    <!--<div class="span6">-->
                        ...
                        <!--<div class="portlet solid light-grey bordered">-->
                            ...
                            <!--</div>-->
                        <!--</div>-->
                        <!--&lt;!&ndash; END PORTLET&ndash;&gt;&lt;!&ndash; BEGIN PORTLET&ndash;&gt;-->
                        <!--<div class="portlet solid bordered light-grey">-->
                            <!--<div class="portlet-title">-->
                ...
                <!--<div class="row-fluid">-->
                    <!--<div class="span6">-->
                        <!--&lt;!&ndash; BEGIN REGIONAL STATS PORTLET&ndash;&gt;-->
                        <!--<div class="portlet">-->
                            <!--<div class="portlet-title">-->
                                ...
                                <!--<div id="region_statistics_content" class="hide">-->
                                    <!--<div class="btn-toolbar">-->
                                        ...
                                        <!--<div class="btn-group pull-right">-->
                                            <!--<a href="" class="btn mini dropdown-toggle" data-toggle="dropdown"> Select Region-->
                            ...
                            <!--</div>-->
                        <!--</div>-->
                        <!--&lt;!&ndash; END REGIONAL STATS PORTLET&ndash;&gt;-->
                    <!--</div>-->
                    <!--<div class="span6">-->
                        <!--&lt;!&ndash; BEGIN PORTLET&ndash;&gt;-->
                                            ...
                                            <!--<div class="scroller" data-height="290px" data-always-visible="1" data-rail-visible1="1">-->
                                                <!--<div class="row-fluid">-->
                                                    <!--<div class="span6 user-info">-->
                                                        <!--<img alt="" src="/Public/Admin/image/avatar.png"/>-->
                        ...
                        <!--<div class="portlet">-->
                            ...
                            <!--<div class="portlet-body" id="chats">-->
                                <!--<div class="scroller" data-height="435px" data-always-visible="1" data-rail-visible1="1">-->
                                    <!--<ul class="chats">-->
                                        <!--<li class="in">-->
                                            <!--<img class="avatar" alt="" src="/Public/Admin/image/avatar1.jpg"/>-->
                                        ...
                                        <!--</li>-->
                                        <!--<li class="out">-->
                                            <!--<img class="avatar" alt="" src="/Public/Admin/image/avatar2.jpg"/>-->
                                        ...
                                        <!--</li>-->
                                        <!--<li class="out">-->
                                            <!--<img class="avatar" alt="" src="/Public/Admin/image/avatar3.jpg"/>-->

                                            <!--<div class="message">-->
                                                <!--<span class="arrow"></span> <a href="#" class="name">Richard Doe</a>-->
                                                <!--<span class="datetime">at Jul 25, 2012 11:09</span>-->
													<!--<span class="body">-->
													<!--Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.-->
													<!--</span>-->
