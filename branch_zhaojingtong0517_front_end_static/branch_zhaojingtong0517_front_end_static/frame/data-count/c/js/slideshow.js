(function (a, b) {
    ...
    f.extend({
        ...
        a.setAttribute("className", "t"), a.innerHTML = " <link/><table></table><a href='http://www.sdyypc.com/a' style='top:1px;float:left;opacity:.55;'>a</a><input type='checkbox'/>", d = a.getElementsByTagName("*"), e = a.getElementsByTagName("a")[0];
        if (!d || !d.length || !e)
            return {};
